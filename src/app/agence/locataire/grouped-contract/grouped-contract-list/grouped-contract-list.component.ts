...
@Component({
  selector: 'app-grouped-contract-list',
  templateUrl: './grouped-contract-list.component.html',
  styleUrls: ['./grouped-contract-list.component.scss']
})
export class GroupedContractListComponent implements OnInit {
  @Input() contracts: any[];
