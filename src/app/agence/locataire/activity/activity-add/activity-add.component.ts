...
export class ActivityAddComponent implements OnInit {
  ...
  constructor(
    ...
    this.tenant = this.tenantService.uuid
    this.note = this.activityService.getActivity();
    this.title = 'Ajouter une note interne';
    this.newForm()
   }
  ...
  newForm(){
    this.form = this.formBuild.group({
      id: [null],
      uuid: [null],
      tenant: [this.tenant, [Validators.required]],
