...
import { SyndicCondominiumAddComponent} from '../syndic-condominium-add/syndic-condominium-add.component';
import { SyndicCondominiumShowItemComponent } from '../syndic-condominium-show-item/syndic-condominium-show-item.component';
import { DateHelperService } from '@theme/utils/date-helper.service';

@Component({
  selector: 'app-syndic-condominium-show',
  templateUrl: './syndic-condominium-show.component.html',
  styleUrls: ['./syndic-condominium-show.component.scss']
})
export class SyndicCondominiumShowComponent implements OnInit {
  ...
  constructor(
    ...
    if(this.coproprieteService.exit === 'VERTICAL'){
      ...
      this.coproprieteService.exit = null
    }else {
      this.getLot()
    }
   }
