...
@Component({
  selector: 'app-syndic-condominium-show-item',
  templateUrl: './syndic-condominium-show-item.component.html',
  styleUrls: ['./syndic-condominium-show-item.component.scss']
})
export class SyndicCondominiumShowItemComponent implements OnInit {
