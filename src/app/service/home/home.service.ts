...
export class HomeService {
  ...
  private namespace = "agency/home";
  private url = "private/agency/home";
  ...
  create(data: Home): Observable<any> {
  ...
  update(data: Home): Observable<any> {
  ...
  getList(promotion?: string, building?: string, type?: string): Observable<Home[]>  {
    if (!navigator.onLine) {
      NoInternetHelper.internet()
      return Observable.create(obs => {
        obs.next();
  ...
  getTravaux(home?: string): Observable<Home[]>  {
    if (!navigator.onLine) {
      NoInternetHelper.internet()
      return Observable.create(obs => {
        obs.next();
  ...
  getLiaison(home?: string): Observable<Home[]>  {
    if (!navigator.onLine) {
      NoInternetHelper.internet()
      return Observable.create(obs => {
        obs.next();
  ...
  getSingle(uuid: string): Observable<Home> {
    if (!navigator.onLine) {
      NoInternetHelper.internet()
      return Observable.create(obs => {
        obs.next();
