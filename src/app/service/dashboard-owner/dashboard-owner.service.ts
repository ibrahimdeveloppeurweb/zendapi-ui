...
export class dashboardOwnerService {
  ...
  private namespace = "dashboard/agency";
  private url = 'private/dashboard/agency';
  ...
  getPrinter(data: any, agencyKey: string, userKey: string, ): void {
    ...
    // let url = 'printer/dashboard/agency' + '/' + 'owner' + '/' + agencyKey + '/' + userKey;
    let url = 'printer/' + this.namespace + '/' + 'owner' + '/' + agencyKey + '/' + userKey;
