...
export class BesoinService {besoin: any;
  public edit: boolean = false;
  public type: string = "VENTE";
  public uuid: string = ''
  private urlBase = environment.publicUrl;
  private namespace = "agency/besoin";
  private url ='private/agency/besoin';

  constructor(private api: ApiService) {}

  setBesoin(besoin: any) {
    this.besoin = besoin
  }
  ...
  getList(prospect: string = null, status: string = "VENTE", archiver: string = "NON", etat: string = null): Observable<any[]> {
    if (!navigator.onLine) {
      NoInternetHelper.internet()
      return Observable.create(obs => {
        obs.next();
